...
const CORE_VALUES = [
  {
    ...
    desc: "Building a global community where readers connect, share, and discover their next favorite book.",
    icon: Globe,
  },
  {
    title: "Promote Sustainability",
    desc: "Giving pre-loved books a second life, supporting eco-friendly reading habits.",
    icon: Zap,
  },
  {
    title: "Ensure Trust",
    desc: "Maintaining a transparent and secure platform through verified users and monitored exchanges.",
    icon: ShieldCheck,
  },
  {
    title: "Champion Accessibility",
    desc: "Making literature accessible and affordable to every reader, everywhere.",
    icon: BookOpen,
  },
];
...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen py-26 bg-gray-50">
      {/* Banner */}
      ...
      <section className=" bg-rose-50 rounded-2xl">
        <OrbitCarousel />
      </section>
        <div>
          <h3 className="text-base font-semibold text-rose-600 uppercase tracking-wider mb-2">
            Our Story
          </h3>
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6 border-l-4 border-rose-500 pl-4 italic">
            "BookMate was founded on a simple belief: that every book deserves a
            new reader, and every reader deserves a simple, trusted way to find
            their next literary adventure."
          </p>

          <h4 className="text-2xl font-bold text-gray-800 mb-3">Our Mission</h4>
          <p className="text-gray-600 leading-relaxed mb-6">
            To create the most secure and vibrant global platform for book
            exchange, fostering a culture of lifelong learning, community
            connectivity, and environmental stewardship through sustainable
            reading practices.
          </p>
          <Link
      ...
      <section id="features" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <h3 className="text-base font-semibold text-rose-600 uppercase tracking-wider text-center mb-2">
            Our Foundation
          </h3>
          <h2 className="text-4xl font-extrabold text-gray-900 text-center mb-12">
            Driving Principles & Core Values
          </h2>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "BookMate makes exchanging books seamless, secure, and incredibly rewarding. It's revitalized my reading life.",
                author: "Sarah K., Verified User",
              },
              {
                quote:
                  "The commitment to verified trades gives me absolute confidence when swapping books with new members. A truly trustworthy platform.",
                author: "Rajib H., Long-time Member",
              },
              {
                quote:
                  "More than an exchange, it's a vibrant, active community of dedicated book lovers. The global reach is unmatched.",
                author: "Lina M., Community Leader",
              },
            ].map((testimonial, idx) => (
              <motion.div
                key={idx}
              ...
              >
                ...
                {/* Added a quote icon for flair */}
                <p className="text-lg text-gray-700 italic mb-4 flex-grow">
                  "{testimonial.quote}"
                </p>
      ...
      <section className="py-20 text-center bg-white border-t border-gray-200">
        <h2 className="text-4xl font-extrabold text-gray-900 mb-4">
          Ready to Re-imagine Your Library?
        </h2>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
          Join thousands of passionate readers in the world's fastest-growing
          book exchange community. Start sharing today.
        </p>
        <Link
          href="/register"
...
const Quote = (props) => (
  <svg
    ...
    {...props}
  >
    <path d="M3 21c3 0 7-12 11-12c1.03 0 2 0.28 2 1s-1 2-2 2s-2 1-2 2s1 3 4 3c4 0 7-12 11-12c1.03 0 2 0.28 2 1s-1 2-2 2s-2 1-2 2s1 3 4 3" />
  </svg>
);
