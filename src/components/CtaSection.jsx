...
export default function CtaSection() {
    return (
        <div className='my-24 px-4'>
            <div className="relative container mx-auto h-[450px] bg-[url('/cta-banner.jpg')]  space-y-12 rounded-2xl lg:flex justify-center items-center bg-cover bg-center bg-fixed">
